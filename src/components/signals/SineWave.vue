<template>
  <div class="sine-wave-generator bg-gray-800/50 rounded-lg p-3 border border-gray-700">
    <div class="flex items-center justify-between mb-3">
      <span class="text-xs font-bold text-green-300">SINE WAVE</span>
    ...
    <div class="grid grid-cols-2 gap-3">
      <Knob v-model="frequency" :min="20" :max="20000" :step="1" label="Frequency" unit="Hz" color="#10b981" />
      <Knob v-model="volume" :min="-60" :max="0" :step="1" label="Volume" unit="dB" color="#10b981" />
    </div>
  </div>
</template>
