  ...
  <div class="master-fader-container flex flex-col items-center gap-1 w-10">
    ...
    <div class="flex items-start gap-px" :style="{ height: trackHeight + 'px' }">
      ...
      >
        ...
        <!-- Fader cap/thumb - DARK GRAY VERSION -->
        <div
        ...
        >
          ...
          <div class="relative w-full h-full rounded overflow-hidden border-2 border-gray-700 bg-gray-600 shadow-lg">
            ...
            <div class="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-3/4 h-0.5 bg-gray-900/90 rounded-full"></div>
          </div>
...
const thumbPosition = computed(() => {
  ...
  return position * props.trackHeight - 25 // -25 to center the 50px cap
})
