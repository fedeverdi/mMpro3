...
contextBridge.exposeInMainWorld('audioEngine', {
  ...
  setSolo: (track: number, solo: boolean) => ipcRenderer.invoke('audio-engine:set-solo', track, solo),
  ...
  setTrackSourceFile: (track: number, filePath: string, artist?: string|null, title?: string|null, playlistId?: string|null, playlistName?: string|null, playlistIndex?: number|null) => 
    ipcRenderer.invoke('audio-engine:set-track-source-file', track, filePath, artist, title, playlistId, playlistName, playlistIndex),
