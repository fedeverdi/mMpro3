...
struct TrackMeters {
    track: usize,
    level_l: f32,               // Post-fader levels (normal)
    level_r: f32,
    level_pre_fader_l: f32,     // Pre-fader levels (for PFL)
    level_pre_fader_r: f32,
    waveform: Vec<f32>,
...
struct MasterParameters {
    ...
    linked: Option<bool>,
    eq_filters: Option<Vec<ParametricFilter>>,
    current_eq_preset: Option<Option<String>>,
